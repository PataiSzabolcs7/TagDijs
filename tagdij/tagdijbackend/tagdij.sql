...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2024. Már 20. 08:50
...
(1017, 'Peter', '0000-00-00', 1030, 'RO'),
(1018, NULL, NULL, NULL, NULL),
(1019, NULL, NULL, NULL, NULL),
(1020, 'Eva', '0000-00-00', 4032, 'H');
...
--
ALTER TABLE `ugyfel`
  MODIFY `azon` int(4) NOT NULL AUTO_INCREMENT COMMENT 'az ügyfél azonosítója', AUTO_INCREMENT=1021;
